...
public class ProjectLifecycleTests : BaseIntegrationTest
{
    ...
    {
        CreateProject.Request createRequest = new("Test Project Lifecycle", "REG-LIFECYCLE-001", DateTime.UtcNow.Date, DateTime.UtcNow.Date.AddDays(30));
        ...
        UpdateProject.Request updateRequest = new("Updated Lifecycle Project", "REG-LIFECYCLE-002", createRequest.StartDate, createRequest.EndDate);
