...
export const EmployeesTable = ({ employees }: { employees: EmployeeItem[] }) => {
          ...
          <tbody>
            {employees.map((employee) => (
              <tr key={employee.id} className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm text-gray-900">{employee.employeeTypeId === "1" ? Texts.academic : Texts.nonAcademic}</td>
