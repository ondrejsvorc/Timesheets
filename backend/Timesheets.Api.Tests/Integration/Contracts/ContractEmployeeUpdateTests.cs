...
public class ContractEmployeeUpdateTests : BaseIntegrationTest
{
    ...
    public async Task UpdateImpact_Split_ReturnsCreatesNewAssignment()
    {
        ...
        ContractEmployeeUpdateRequest request = new(
            "POS-01",
            "Senior Developer",
            1.0m,
        ...
        HttpResponseMessage response = await Client.PostAsJsonAsync(
            $"/api/contracts/{setup.ContractId}/employees/{setup.ContractEmployeeId}/update-impact",
            request);
    ...
    public async Task UpdateContractEmployee_Split_EndsOldAndCreatesNew()
    {
        ...
        HttpResponseMessage response = await Client.PutAsJsonAsync(
            $"/api/contracts/{setup.ContractId}/employees/{setup.ContractEmployeeId}",
            request);
        ...
        Data.Models.ContractEmployee? oldAssignment = await dbContext.ContractEmployees
            .AsNoTracking()
            .SingleOrDefaultAsync(assignment => assignment.Id == setup.ContractEmployeeId);
    ...
    public async Task UpdateImpact_ShortenEnd_WithDraftDaysOutside_ReturnsDraftDaysToRemove()
    {
        ...
        ContractEmployeeUpdateRequest request = new(
            ...
            1.0m,
            new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc),
            new DateTime(2024, 11, 30, 0, 0, 0, DateTimeKind.Utc));
    ...
    public async Task UpdateContractEmployee_ShortenEnd_RemovesDraftDaysOutsideRange()
    {
        ...
        int decemberDayCount = await dbContext.ProjectDays
            .AsNoTracking()
            .Where(day => day.ProjectTimesheet.ContractEmployeeId == setup.ContractEmployeeId)
            .Where(day => day.Date > new DateTime(2024, 11, 30, 0, 0, 0, DateTimeKind.Utc))
            .CountAsync();
    ...
    private async Task<Guid> GetProjectTimesheetIdAsync(Guid contractEmployeeId, int year, int month)
    {
        ...
        return await dbContext.ProjectTimesheets
            ...
            .Where(timesheet => timesheet.Year == year && timesheet.Month == month)
