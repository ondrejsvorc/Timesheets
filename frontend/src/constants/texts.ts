export const Texts = {
  ...
  deleteImpactProjectTimesheetsApproved: "Schválené výkazy · {count}",
  ...
  deleteImpactForceDelete: "Jsou zde výkazy ke schválení nebo schválené. Jako správce systému je smažete včetně nich.",
