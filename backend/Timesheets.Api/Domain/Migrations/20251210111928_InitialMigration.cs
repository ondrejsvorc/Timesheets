        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000013"), "Omluvená nepøítomnost - tvùrèí volno", 0m, "M" },
                    { new Guid("00000000-0000-0000-0000-000000000014"), "Mateøská dovolená / Otcovská dovolená", 0m, "MD/OD" },
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000017"), "Návštìva lékaøe - krátkodobá", null, "NK" },
                    { new Guid("00000000-0000-0000-0000-000000000018"), "Návštìva lékaøe - celý den", 0m, "NL" },
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000021"), "Ošetøovné", 0m, "O" },
                    { new Guid("00000000-0000-0000-0000-000000000022"), "Osobní pøekážky", null, "OPN" },
                    { new Guid("00000000-0000-0000-0000-000000000023"), "Narození dítìte", 0m, "PN" },
                    { new Guid("00000000-0000-0000-0000-000000000024"), "Odbìr krve", null, "PO" },
                    { new Guid("00000000-0000-0000-0000-000000000025"), "Svatba", 0m, "PS" },
                    { new Guid("00000000-0000-0000-0000-000000000026"), "Úmrtí rod. pøíslušníka", 0m, "PU" },
                    { new Guid("00000000-0000-0000-0000-000000000027"), "Pracovní volno pro brannou povinnost", 0m, "PVB" },
                    { new Guid("00000000-0000-0000-0000-000000000028"), "Pracovní volno pro s akcí pro dìti a mládež", 0m, "PVM" },
                    { new Guid("00000000-0000-0000-0000-000000000029"), "Pøekážka na stranì zamìstnavatele", 0m, "PZ" },
                    { new Guid("00000000-0000-0000-0000-000000000030"), "Rodièovská dovolená", 0m, "RD" },
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000034"), "Služební cesta zahranièní", null, "SCZ" },
                    { new Guid("00000000-0000-0000-0000-000000000035"), "Zahranièní služební cesta Erasmus", null, "SCZE" },
                    { new Guid("00000000-0000-0000-0000-000000000036"), "Zahranièní služební cesta Projekt", null, "SCZP" },
                    { new Guid("00000000-0000-0000-0000-000000000037"), "Zahranièní služební cesta Stáž", null, "SCZS" },
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000040"), "Nové zamìstnání", 0m, "VZ" },
                    { new Guid("00000000-0000-0000-0000-000000000041"), "Volno pro obecný zájem", 0m, "Z" },
                    { new Guid("00000000-0000-0000-0000-000000000042"), "Veøejná funkce - poslanec", null, "Zp" },
                    { new Guid("00000000-0000-0000-0000-000000000043"), "Dlouhodobý pobyt v cizinì", null, "Zs" },
